...
%*********************************************************************************
\newcommand{\autore}{Giacomo Lombardo}                 % Autore tesi
\newcommand{\relatore}{Prof.ssa Liliana Lo Presti}           % Relatore
...
\newcommand{\titolotesi}{%                                   % Titolo della tesi
  \uppercase{Vision Transformer Pruning using Hessian-Guided Neural Architecture Search}}
